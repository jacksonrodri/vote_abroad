      ...
      <div>
        ...
        <b-tabs type="is-toggle" expanded>
          <b-tab-item :label="$t('request.stages.email')"
            ...
            icon="at">
            <section v-if="isIE || /AR|CA|CT|NJ|NY|WY/.test(currentRequest.leo.s)" class="section">
