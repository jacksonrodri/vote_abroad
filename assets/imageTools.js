...
export default class ImageTools {
  static resize (file, maxDimensions, callback) {
    ...
    let maxWidth = maxDimensions.width // eslint-disable-line no-unused-vars
    let maxHeight = maxDimensions.height // eslint-disable-line no-unused-vars
  ...
  static _toBlob (canvas, type) {
    ...
    if (hasBlobConstructor) {
      ...
      let bb = new BlobBuilder() // eslint-disable-line no-undef
