...
a._.width == this.width && a._.height == this.height || B.call(this, d || a._.width, c || a._.height); a._.use(); this._.texture.drawTo(function () { h.getDefaultShader().drawRect() }); return this
...
d + 'gl_FragColor=texture2D(texture,coord/texSize);vec2 clampedCoord=clamp(coord,vec2(0.0),texSize);if(coord!=clampedCoord){gl_FragColor.a*=max(0.0,1.0-length(coord-clampedCoord));}}')
  ...
  } function t (a) { a = new z(a); for (var d = [], c = 0; c < 256; c++)d.push(q(0, Math.floor(256 * a.interpolate(c / 255)), 255)); return d } function I (b, d, c) {
    ...
    for (var d = 0; d < 2; d++)f.call(this, a.denoise, {exponent: Math.max(0, b), texSize: [this.width, this.height]}); return this
  } function K (b, d) {
...
[b[0], b[1], 0, b[2], b[3], 0, 0, 0, 1]
    } else if (b.length != 9) throw 'can only warp with 2x2 or 3x3 matrix'; f.call(this, a.matrixWarp, {matrix: d ? y(b) : b, texSize: [this.width, this.height], useTextureSpace: c | 0}); return this
  } function aa (a, d) {
    ...
    function a (b) {
      ...
      b.texImage2D(b.TEXTURE_2D, 0, b.RGBA, 1, 1, 0, b.RGBA, b.UNSIGNED_BYTE, null); b.bindFramebuffer(b.FRAMEBUFFER, c); b.framebufferTexture2D(b.FRAMEBUFFER, b.COLOR_ATTACHMENT0, b.TEXTURE_2D, e, 0); c = b.createTexture(); b.bindTexture(b.TEXTURE_2D, c); b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MAG_FILTER, b.LINEAR); b.texParameteri(b.TEXTURE_2D, b.TEXTURE_MIN_FILTER, b.LINEAR); b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_S, b.CLAMP_TO_EDGE); b.texParameteri(b.TEXTURE_2D, b.TEXTURE_WRAP_T, b.CLAMP_TO_EDGE); b.texImage2D(b.TEXTURE_2D,
        ...
        g); b.linkProgram(e); d = b.createBuffer(); b.bindBuffer(b.ARRAY_BUFFER, d); b.bufferData(b.ARRAY_BUFFER, new Float32Array([0, 0]), b.STREAM_DRAW); b.enableVertexAttribArray(0); b.vertexAttribPointer(0, 2, b.FLOAT, !1, 0, 0); d = new Uint8Array(4); b.useProgram(e); b.viewport(0, 0, 1, 1); b.bindTexture(b.TEXTURE_2D, c); b.drawArrays(b.POINTS, 0, 1); b.readPixels(0, 0, 1, 1, b.RGBA, b.UNSIGNED_BYTE, d); return d[0] === 127 || d[0] === 128
    } function d () {} function c (a) {
      a === 'OES_texture_float_linear' ? (void 0 === this.$OES_texture_float_linear$ && Object.defineProperty(this,
    ...
    } function e () { var a = f.call(this); a.indexOf('OES_texture_float_linear') === -1 && a.push('OES_texture_float_linear'); return a } try { var g = document.createElement('canvas').getContext('experimental-webgl') } catch (l) {} if (g && g.getSupportedExtensions().indexOf('OES_texture_float_linear') === -1 && a(g)) {
    ...
    function b (b, c) {
      ...
      a.useProgram(this.program); for (var e in b) {
        if (b.hasOwnProperty(e)) {
          var c = a.getUniformLocation(this.program, e); if (c !== null) {
            var d = b[e]; if (Object.prototype.toString.call(d) == '[object Array]') {
              switch (d.length) {
            ...
            } else if (Object.prototype.toString.call(d) == '[object Number]')a.uniform1f(c, d); else throw 'attempted to set uniform "' + e + '" to invalid value ' + (d || 'undefined').toString()
          }
        }
      } return this
      ...
      var f = a.getParameter(a.VIEWPORT); c = void 0 !== c ? (c - f[1]) / f[3] : 0; b = void 0 !== b ? (b - f[0]) / f[2] : 0; e = void 0 !== e ? (e - f[0]) / f[2] : 1; d = void 0 !== d ? (d - f[1]) / f[3] : 1; a.vertexBuffer == null && (a.vertexBuffer = a.createBuffer()); a.bindBuffer(a.ARRAY_BUFFER, a.vertexBuffer); a.bufferData(a.ARRAY_BUFFER, new Float32Array([b,
...
this.xa[d], g = (this.xa[c] - a) / e; a = (a - this.xa[d]) / e; return g * this.ya[d] + a * this.ya[c] + ((g * g * g - g) * this.y2[d] + (a * a * a - a) * this.y2[c]) * e * e / 6
      ...
      } function d (a) { c == null && (c = document.createElement('canvas')); c.width = a.width; c.height = a.height; a = c.getContext('2d'); a.clearRect(0, 0, c.width, c.height); return a }b.fromElement = function (c) { var d = new b(0, 0, a.RGBA, a.UNSIGNED_BYTE); d.loadContentsOf(c); return d }; b.prototype.loadContentsOf = function (b) {
