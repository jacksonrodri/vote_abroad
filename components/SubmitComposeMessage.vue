    ...
    <section>
      ...
      <b-field horizontal :label="$t('request.sig.from')">
        <b-field>
          <b-input
            v-model="fromName"
            name="name"
            :placeholder="$t('request.sig.name')"
        ...
        <b-field>
          <b-input
            ...
            name="email"
            type="email"
            :placeholder="$t('request.email.label')"
            :disabled="!!email"
            required
            expanded
          ></b-input>
      ...
      <b-field horizontal :label="$t('request.sig.to')">
        ...
        <b-input
          ...
          name="LeoEmail"
          type="email"
          placeholder="election@example.com"
          disabled
          expanded
        ></b-input>
      </b-field>
        ...
        <div class="media-content">
          <span
            ...
            v-html="
              md(
                $t(
                  `request.deadlineLanguage.${currentRequest.leo.s.toUpperCase()}Special`,
                  instructionsObject
                )
              )
            "
...
export default {
  ...
  mounted () {
    ...
    this.message = `Please see attached my FPCA form for the current calendar year. Can you confirm receipt? I will send the original signed copy by mail. \n\nThank you so much for everything you do. Your work is much appreciated by Americans abroad! \n\nSincerely, \n\n${this.firstName} ${this.lastName} \n\n${this.formEmail} \n\n${this.tel}`
  }
}
</script>
